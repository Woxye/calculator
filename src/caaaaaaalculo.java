 ...
 * @author junio
 */
public class caaaaaaalculo extends javax.swing.JFrame {

    /**
     * Creates new form caaaaaaalculo
     */
    public caaaaaaalculo() {
        initComponents();
        URL icone = getClass().getResource("/imagens/imagem/ca.jpg");
        Image iconeTit = Toolkit.getDefaultToolkit().getImage(icone);
        this.setIconImage(iconeTit);
    }
    ...
    private void initComponents() {
        ...
        caixatexto.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGap(30, 30, 30)
                .addComponent(caixatexto, javax.swing.GroupLayout.PREFERRED_SIZE, 62, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(33, 33, 33)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        caixatexto.setText(caixatexto.getText()+ "5");// TODO add your handling code here:
    ...
    private void jButton18ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton18ActionPerformed
        valor1 = Double.parseDouble(caixatexto.getText());
        caixatexto.setText("");
        sinal = "soma";
    ...
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        if("soma".equals(sinal)){
            valor2 = Double.parseDouble(caixatexto.getText());
            caixatexto.setText(String.valueOf(valor1 + valor2));
        }else if("subtracao".equals(sinal)){
            valor2 = Double.parseDouble(caixatexto.getText());
            caixatexto.setText(String.valueOf(valor1 - valor2));
        }else if("multiplicacao".equals(sinal)){
            valor2 = Double.parseDouble(caixatexto.getText());
            caixatexto.setText(String.valueOf(valor1 * valor2));
        }else if("divisao".equals(sinal)){
            valor2 = Double.parseDouble(caixatexto.getText());
            caixatexto.setText(String.valueOf(valor1 / valor2));
        }
    ...
    private void jButton13ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton13ActionPerformed
        String str = caixatexto.getText();
        char ch = str.charAt(str.length()-1);
        str = str.replace(String.valueOf(ch),""); 
        caixatexto.setText(str);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(caaaaaaalculo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new caaaaaaalculo().setVisible(true);
            }
        });
    }
